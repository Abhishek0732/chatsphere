      ...
      <div className="space-y-3">
        ...
        <div className="max-h-72 overflow-y-auto scrollbar-thin">
          {isFetching ? (
            ...
            <p className="py-6 text-center text-sm text-on-surface-variant">Type at least 2 characters.</p>
          ) : (results ?? []).length === 0 ? (
            <p className="py-6 text-center text-sm text-on-surface-variant">No users found.</p>
          ) : (
            (results ?? [])
              .filter((u) => u.id !== myId)
              .map((u) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isContact ? (
                      ...
                      <span className="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-1.5 text-xs font-medium text-on-surface-variant">
