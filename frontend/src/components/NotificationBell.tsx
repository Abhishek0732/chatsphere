      ...
      {open &&
        createPortal(
          <div
            ...
            className="z-[80] max-h-[70vh] w-80 max-w-[calc(100vw-5rem)] overflow-y-auto rounded-xl border border-slate-200 bg-white shadow-xl scrollbar-thin dark:border-white/10 dark:bg-[#17233c]"
          >
